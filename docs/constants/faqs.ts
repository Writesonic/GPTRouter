...
const FAQS: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "GPTRouter can be deployed anywhere but we prefer deploying it on AWS ECS and IAAC templates for same can be found in our documentation, we are also in process to release Railway.app templates for same.",
  },
];
