                            ...
                            <div className="mx-auto max-w-sm space-y-3">
                                <div className="flex items-center">
                                    ...
                                    >
                                        ...
                                        {
                                            loading &&
                                            <svg aria-hidden="true" className="w-6 h-6 ml-2 text-white animate-spin dark:text-white fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
